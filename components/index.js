...
function App() {
  ...
  const handleStart = (e) => {
    ...
    if (isLoggedIn) {
      ...
      // call put users/{me}/unregister alpha
      ...
      // call put users/{me}/unregister Beta
            ...
            <div className='sticky-addition' style={{ paddingTop: 2 }}>
              <div className='bg-light ms-4' style={{ width: "fit-content", paddingLeft: 30, marginTop: 38, paddingBottom: 20, paddingTop: 10, paddingRight: 30, fontSize: ".74rem", borderRadius: 10 }}>
                ...
                <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                  id='socialType' value={locale} onChange={handleSelectLocale}
                >
                ...
                Social-type &#160;
                <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                  id='socialType' value={socialType} onChange={(e) => handleSelectSocialType(e, 1)}
                >
                ...
                Auto fill PUT&#160;
                <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                  id='socialType' value={isAutoPut} onChange={(e) => handleSelectAuto(e, 1)}
                >
                ...
                <select className="form-select-sm mt-2" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                  id='socialType' value={socialTypePut} onChange={(e) => handleSelectSocialType(e, 2)}
                >
                  <option value="facebook">facebook</option>
                  <option value="naver">naver</option>
                  <option value="twitter">twitter</option>
                ...
                Auto fill POST&#160;
                <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                  id='socialType' value={isAutoPost} onChange={(e) => handleSelectAuto(e, 2)}
                >
                  <option value="true">true</option>
                  <option value="false">false</option>
                </select>
                ...
                Auto fill DEL&#160;
                <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                  id='socialType' value={isAutoDel} onChange={(e) => handleSelectAuto(e, 3)}
                >
                  <option value="true">true</option>
                  <option value="false">false</option>
                </select>
                ...
                Social-type &#160;
                <select className="form-select-sm mt-2" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                  id='socialType' value={socialTypeDel} onChange={(e) => handleSelectSocialType(e, 3)}
                >
                  <option value="facebook">facebook</option>
                  <option value="naver">naver</option>
                  <option value="twitter">twitter</option>
                      ...
                      <form>
                        <div className="row align-items-center">
                          ...
                          <span>
                            ...
                            <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                              id='socialType' name='marketingEmail' value={putUserMe.agreements.marketingEmail} onChange={(e) => handlePutChangeValue2(e, 1)}>
                              <option value="true">true</option>
                              <option value="false">false</option>
                            </select>
                          </span>
                          ...
                          <span>
                            ...
                            <label htmlFor="" className="col-form-label">collectingBirth&#160;</label>
                            <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                              id='socialType' name='collectingBirth' value={putUserMe.agreements.collectingBirth} onChange={(e) => handlePutChangeValue2(e, 1)}>
                              <option value="true">true</option>
                              <option value="false">false</option>
                            </select>
                          </span>
                          ...
                          <span>
                            ...
                            <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                              id='socialType' name='timer' value={putUserMe.agreements.timer} onChange={(e) => handlePutChangeValue2(e, 1)}>
                              <option value="true">true</option>
                              <option value="false">false</option>
                            </select>
                          </span>
                          ...
                          <span>
                            ...
                            <select className="form-select-sm mt-1" style={{ fontSize: '.8rem' }} aria-label="Default select example"
                              id='socialType' name='subscription' value={putUserMe.agreements.subscription} onChange={(e) => handlePutChangeValue2(e, 1)}>
                              <option value="true">true</option>
                              <option value="false">false</option>
                            </select>
                          </span>
            ...
            <div className='p-2 highlight' style={{border: '1px solid lightgrey', borderRadius: 5}}>
              ...
              <div className="modal fade" id="putUserUnregisterModal" tabIndex="-1" aria-labelledby="putUserUnregisterModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h5 className="modal-title" id="putUserUnregisterModalLabel">POST /users/me/connect/{socialTypePut}</h5>
                      <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                      <form>
